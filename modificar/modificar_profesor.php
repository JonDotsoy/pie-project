...
<!-- ----------------------------------------------->
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="index.php">PIE</a> <div class="breadcrumb_divider"></div> <a class="current">Profesores Registrados</a></article>
		</div>
...
<!-- ----------------------------------------------->
	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			<header><h3>Profesores Registrados</h3></header>
